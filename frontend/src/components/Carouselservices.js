...
return (
    <div className="bg-[#AFE5DA] text-center mt-16 sm:mx-16 xl:mx-20 pb-10 pt-10 px-9 sm:px-12 md:px-40">
    <h1 className="text-xl sm:text-3xl md:text-4xl lg:text-4xl pt-2 sm:pt-12 font-bold font-mono" >SERVICES</h1>
