...
export default function Footer1() {
  return (
    <div
      className={`container-fluid text-center   px-16  sm:pt-4 md:pb-4 pt-4 md:pt-16 xl:pt-20  xl:px-40 `}
    ...
    >
      <div class="row mb-6 justify-content-between ">
        ...
        <div className='font- d-flex   flex-lg-row justify-content-around'>
                            ...
                            <a className={`block text-center ${classes.font_poppins} `}href='#w'> Features </a>
                            <a className={`block text-center ${classes.font_poppins} `}href='#w'> services </a>
                            <a className={`block text-center ${classes.font_poppins} `}href='#w'> contact </a>
                        </div>
        </div>
      </div>
...
<a className='col-8 offest-2 offset-sm-3 my-2 col-sm-5 mx-2 flex border-1 rounded-lg  text-2xl py-1 px-2 border-black' href='#w'>
    <i className="fab fa-google-play my-auto"></i> <p className=' my-auto ml-2'>Play Store </p>
</a>
<a className='col-8 offset-2 offset-sm-3 my-2 col-sm-5 mx-2  flex border-1 rounded-lg text-2xl py-1 px-2 border-black' href='#w'>
