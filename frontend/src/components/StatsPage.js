...
export default function StatsPage() {
  return (
    <div className='py-10 md:-mt-28 -mb-28 z-10'>
    <div className='w-11/12 sm:w-8/12 bg-gradient-to-t from-navy to-cyan-500 py-12 mx-auto rounded-xl flex text-white text-center'>
        ...
        <div className='w-full sm:w-4/12'>
            ...
            <p className='text-5xl font-bold mt-3 mb-2 sm:border-r-2 border-white'> 7+ </p>
